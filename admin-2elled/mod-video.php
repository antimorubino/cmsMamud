...
$rgVideo = $video->elenVideo($_GET['idVideo']);
$row = $rgVideo->fetch(PDO::FETCH_BOTH);
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 mt-3">
        <div class="card-body">
            ...
            <form class="" method="post" enctype="multipart/form-data">
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="link" class="form-control" value="<?php echo $row['LinkUrl']; ?>" />
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        ?>
                        <img src="../storage/video/crop/<?php echo $foto; ?>" /><br /><br />
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" id="sel1" name="categoria">
                            <option value="1" <?php if($row['Sorgente'] == 1) {echo 'selected=selected'; } ?>>YouTube</option>
                            <option value="2" <?php if($row['Sorgente'] == 2) {echo 'selected=selected'; } ?>>Vimeo</option>
                        </select>
                    </div>
                </div>
            ...
            $video->modVideo($_GET['idVideo'], $_GET['lang'], $nomeFile);
            endif;
            ?>
        </div>
    </div>
