...
class Stringhe {
	...
	public static function puliscistringa($stringa) {
	...
	$stringa = str_replace("í", "i", $stringa);
	...
	$stringa = str_replace("&ntilde;", "n", $stringa);
	...
	public static function cutHtmlText($html, $length, $ending, $strip_tags, $cut_words, $cut_images) {
...
$dataConv = $dtexplode['2']."-".$dtexplode['1']."-".$dtexplode['0'];

return $dataConv;

}

public static function encodeDec($stringa, $charset){

return html_entity_decode($strinda, ENT_QUOTES, $charset);
